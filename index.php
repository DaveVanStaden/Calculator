	...
	function calc($num1,  $num2,  $num3,  $num4, $operand)
	{
        ...
        case "/":
            if ($num1==0 or $num2==0 or $num3==0 or $num4==0)
                return"Met 0 delen is niet mogenlijk";
...
<html lang="en">
	  <head>
		...
		<style type="text/css">
				body 	{background-color:deeppink; font-family: "Courier", monospace;}
				input   {color:black;}
				p    	{color:aqua;font-weight: bold;}
				legend  {color:aqua; font-size: 200%;}
				fieldset{width: 250px;margin: auto; background-color: mediumpurple;}
		</style>
	  </head>
	  <body>

		<div> Dave van Staden GD1A</div>
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
			<fieldset>
				<legend>Berekening</legend>
				<p>A: <input type="text" name="num1" placeholder = "getal" value = "<?= $num1 ?>"></p>
				<p>B: <input type="text" name="num2" placeholder = "getal" value = "<?= $num2?>"></p>
                <p>C: <input type="text" name="num3" placeholder = "getal" value = "<?= $num3?>"></p>
                <p>D: <input type="text" name="num4" placeholder = "getal" value = "<?= $num4?>"></p>
